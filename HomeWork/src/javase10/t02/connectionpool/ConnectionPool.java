...
public class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        url = dbResourceManager.getValue(DBParametr.DB_URL);
        user = dbResourceManager.getValue(DBParametr.DB_USER);
        password = dbResourceManager.getValue(DBParametr.DB_PASSWORD);
    ...
    public void initPooldData() throws ConnectionPoolException {
    ...
    private void closeConnectionQueue(BlockingQueue<Connection> queue) throws SQLException {
        ...
        while ((connection = queue.poll()) != null) {
            ...
            ((PooledConnection) connection).realyClose();
        }
    }
    ...
    public void closeConnectionQueue(Connection con, Statement st, ResultSet rs) {
        ...
        try {
            ...
            System.out.println("ResultSet isn't closed.");
        }

        try {
            st.close();
        } catch (SQLException e) {
            System.out.println("Statement isn't closed.");
        }
    }
    ...
    private class PooledConnection implements Connection {
        ...
        public void close() throws SQLException {
            ...
            if (!givenAwayConQueue.remove(this)) {
                throw new SQLException("Error deleting connection from the give away connections pool.");
            }
            if(!connectionQueue.offer(this)) {
                throw new SQLException("Error allocating connection it the pool.");
            }
